...
angular.module('mean.system').controller('SupplierArchiveController', ['$scope','$http','$location', '$rootScope', 'Global', 'Menus','$stateParams',
  function($scope,$http,$location,$rootScope, Global, Menus,$stateParams) {

	  $http.get('/supplierarchived')
...
$scope.sinvoices=response;
	  ...
	  $scope.restore=function(id){
		  ...
		  $http.get('/supplierinvoice/restore/'+id)
		.success(function(response){
		//$scope.sinvoices=response;
		 location.reload();
